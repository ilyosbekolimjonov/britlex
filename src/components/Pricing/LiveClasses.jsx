...
const LiveClasses = () => {
    return (
        <div className="flex flex-col items-center">
            <img src={liveImg} alt="Live Classes" className="w-full" />
            ...
            <button className="flex items-center gap-2 cursor-pointer bg-[rgba(238,238,238)] border border-gray-200 rounded-lg px-6 py-3">
