...
const Speaking = () => {
    return (
        <div className="lp:row-span-2 bg-gray-200 rounded-lg lp:px-6">
            ...
            <div className="mx-5 lp:mt-8">
                ...
                <button className="h-15 w-[70%] mt-8 mb-12 rounded-xl bg-[rgba(38,50,56)] text-white font-medium text-xl lp:mt-15 cursor-pointer">Learn more</button>
            </div>
        </div>
    )
}
