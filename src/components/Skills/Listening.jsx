...
const Listening = () => {
    return (
        <div className="bg-[rgba(245,245,245)] rounded-lg lp:col-span-2 lp:flex lp:px-5">
            ...
            <div className="mx-5 lp:order-1 lp:w-[40%]">
                ...
                <button className="h-15 w-[70%] mt-2 mb-12 rounded-xl bg-[rgba(38,50,56)] text-white font-medium text-xl lp:mt-0">Learn more</button>
            </div>
        </div>
    )
}
